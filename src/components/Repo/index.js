...
export default function Repo(name, stargazers_count, forks_count) {
  ...
  let repo_name = createElement("p", ["repo_name"])
  ...
  let line_separator = createElement("hr", ["repo--separator"]);

  return createElement("section", ["user-repo"], [info_repo, line_separator])
}
